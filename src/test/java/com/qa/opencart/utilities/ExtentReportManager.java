...
public class ExtentReportManager implements ITestListener {
	...
	public void onFinish(ITestContext testContext) {
		 ...
		 * DefaultAuthenticator("santhusree3579@gmail.com","password"));
		 * email.setSSLOnConnect(true); email.setFrom("santhusree3579@gmail.com");
		 * //Sender email.setSubject("Test Results");
		 * email.setMsg("Please find Attached Report....");
		 * email.addTo("santhusree3579@gmail.com"); //Receiver email.attach(url,
